...
class SimpleKingdomPaySimulator:
    ...
    def test_basic_functionality(self):
        ...
        with self.app.app_context():
            ...
            try:
                ...
                test_results.append({"test": "User Creation", "status": "PASS", "time": time.time() - start_time})
                tests_passed += 1
                print("✅ User creation test passed")
                
            except Exception as e:
                test_results.append({"test": "User Creation", "status": "FAIL", "error": str(e)})
                tests_failed += 1
            ...
            try:
                ...
                test_results.append({"test": "Transaction Creation", "status": "PASS", "time": time.time() - start_time})
                tests_passed += 1
                print("✅ Transaction creation test passed")
                
            except Exception as e:
                test_results.append({"test": "Transaction Creation", "status": "FAIL", "error": str(e)})
                tests_failed += 1
            ...
            try:
                ...
                test_results.append({"test": "OTP Generation", "status": "PASS", "time": time.time() - start_time})
                tests_passed += 1
                print("✅ OTP generation test passed")
                
            except Exception as e:
                test_results.append({"test": "OTP Generation", "status": "FAIL", "error": str(e)})
                tests_failed += 1
                print(f"❌ OTP generation test failed: {str(e)}")
                db.session.rollback()
        ...
        with self.app.test_client() as client:
            with self.app.app_context():
                ...
                endpoints = [
                    ...
                    ('/api/v1/wallets/deposit', 'POST', {'amount': 100.0, 'description': 'Test deposit'}),
                ]
    ...
    def test_database_performance(self):
        ...
        with self.app.app_context():
            ...
            try:
                ...
                print(f"✅ Database performance test completed: {operations_count} operations")
        ...
        with self.app.app_context():
            ...
            try:
                ...
                if not result["success"]:
                    error_tests.append({"test": "Invalid Phone Number", "status": "PASS", "expected": "Should fail"})
                else:
                    error_tests.append({"test": "Invalid Phone Number", "status": "FAIL", "expected": "Should fail"})
            except Exception as e:
                error_tests.append({"test": "Invalid Phone Number", "status": "ERROR", "error": str(e)})
            ...
            try:
                ...
                try:
                    ...
                    error_tests.append({"test": "Insufficient Funds", "status": "FAIL", "expected": "Should fail"})
                except ValueError as e:
                    if "Insufficient funds" in str(e):
                        error_tests.append({"test": "Insufficient Funds", "status": "PASS", "expected": "Should fail"})
                    else:
                        error_tests.append({"test": "Insufficient Funds", "status": "FAIL", "expected": "Should fail"})
                
            except Exception as e:
                error_tests.append({"test": "Insufficient Funds", "status": "ERROR", "error": str(e)})
                db.session.rollback()
    ...
    def generate_recommendations(self):
        ...
        if 'api_endpoints' in self.results['performance_metrics']:
            api_success_rate = self.results['performance_metrics']['api_endpoints']['success_rate']
            if api_success_rate < 100:
                recommendations.append("Investigate API endpoint failures")
            
            avg_response_time = self.results['performance_metrics']['api_endpoints']['avg_response_time']
            if avg_response_time > 0.1:  # 100ms
                recommendations.append("Optimize API response times - currently above 100ms")
        
        # Check database performance
        if 'database_performance' in self.results['performance_metrics']:
            db_success_rate = self.results['performance_metrics']['database_performance']['success_rate']
